...
python3 electra-tamil/run_finetuning.py \
	...
	--hparams '{"task_names": ["squad"], "model_size": "small" }'


python3 electra-tamil/run_finetuning.py \
	--data-dir $DATA_DIR \
	--model-name $MODEL_NAME \
	--hparams '{"do_train": false, "do_eval": true, "model_size": "small",  "task_names": ["squad"], "init_checkpoint": "$DATA_DIR/models/$MODEL_NAME/finetuning_models/squad_model_1"}'
